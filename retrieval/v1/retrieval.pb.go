...
type Alert struct {
	...
	Events    []*Alert_Event `protobuf:"bytes,7,rep,name=events,proto3" json:"events,omitempty"`
}
...
func (x *Alert) GetEvents() []*Alert_Event {
	if x != nil {
		return x.Events
	}
	return nil
...
func (x *FindAlertsReply) GetAlerts() []*Alert {
	if x != nil {
		return x.Alerts
	}
	return nil
...
func (x *GetAlertReply) GetAlert() *Alert {
	if x != nil {
		return x.Alert
	}
	return nil
...
func (x *Alert_Event) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Alert_Event) ProtoMessage() {}

func (x *Alert_Event) ProtoReflect() protoreflect.Message {
	mi := &file_api_retrieval_v1_retrieval_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Alert_Event.ProtoReflect.Descriptor instead.
func (*Alert_Event) Descriptor() ([]byte, []int) {
	return file_api_retrieval_v1_retrieval_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Alert_Event) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *Alert_Event) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
var file_api_retrieval_v1_retrieval_proto_rawDesc = []byte{
	...
	0xf6, 0x01, 0x0a, 0x05, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76, 0x61, 0x6c, 0x2e, 0x41, 0x6c, 0x65,
	0x72, 0x74, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73,
	0x1a, 0x36, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x2c, 0x0a, 0x06, 0x61, 0x6c, 0x65,
	0x72, 0x74, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76, 0x61, 0x6c, 0x2e, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x52,
	0x06, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x73, 0x22, 0x23, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x41, 0x6c,
	...
	0x05, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76, 0x61, 0x6c, 0x2e, 0x41, 0x6c, 0x65,
	0x72, 0x74, 0x52, 0x05, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x22, 0x21, 0x0a, 0x0f, 0x47, 0x65, 0x74,
...
var file_api_retrieval_v1_retrieval_proto_goTypes = []interface{}{
	(*Alert)(nil),              // 0: api.retrieval.Alert
	...
	(*Alert_Event)(nil),        // 9: api.retrieval.Alert.Event
}
var file_api_retrieval_v1_retrieval_proto_depIdxs = []int32{
	9, // 0: api.retrieval.Alert.events:type_name -> api.retrieval.Alert.Event
	0, // 1: api.retrieval.FindAlertsReply.alerts:type_name -> api.retrieval.Alert
	0, // 2: api.retrieval.GetAlertReply.alert:type_name -> api.retrieval.Alert
