...
type CameraClient interface {
	...
	GetBatchCamera(ctx context.Context, in *GetBatchCameraRequest, opts ...grpc.CallOption) (*GetBatchCameraReply, error)
}
...
func (c *cameraClient) GetBatchCamera(ctx context.Context, in *GetBatchCameraRequest, opts ...grpc.CallOption) (*GetBatchCameraReply, error) {
	out := new(GetBatchCameraReply)
	err := c.cc.Invoke(ctx, "/api.camera.v1.Camera/GetBatchCamera", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CameraServer interface {
	...
	GetBatchCamera(context.Context, *GetBatchCameraRequest) (*GetBatchCameraReply, error)
...
func (UnimplementedCameraServer) GetBatchCamera(context.Context, *GetBatchCameraRequest) (*GetBatchCameraReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBatchCamera not implemented")
}
...
func _Camera_GetBatchCamera_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBatchCameraRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CameraServer).GetBatchCamera(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.camera.v1.Camera/GetBatchCamera",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CameraServer).GetBatchCamera(ctx, req.(*GetBatchCameraRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Camera_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBatchCamera",
			Handler:    _Camera_GetBatchCamera_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/camera/v1/camera.proto",
}
