...
type SettingsClient interface {
	...
	ListRegionModules(ctx context.Context, in *ListRegionModulesRequest, opts ...grpc.CallOption) (*ListRegionModulesReply, error)
	ListCameraModules(ctx context.Context, in *ListCameraModulesRequest, opts ...grpc.CallOption) (*ListCameraModulesReply, error)
}
...
func (c *settingsClient) ListRegionModules(ctx context.Context, in *ListRegionModulesRequest, opts ...grpc.CallOption) (*ListRegionModulesReply, error) {
	out := new(ListRegionModulesReply)
	err := c.cc.Invoke(ctx, "/api.settings.v1.Settings/ListRegionModules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingsClient) ListCameraModules(ctx context.Context, in *ListCameraModulesRequest, opts ...grpc.CallOption) (*ListCameraModulesReply, error) {
	out := new(ListCameraModulesReply)
	err := c.cc.Invoke(ctx, "/api.settings.v1.Settings/ListCameraModules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSettingsServer) ListRegionModules(context.Context, *ListRegionModulesRequest) (*ListRegionModulesReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListRegionModules not implemented")
}
func (UnimplementedSettingsServer) ListCameraModules(context.Context, *ListCameraModulesRequest) (*ListCameraModulesReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCameraModules not implemented")
}
...
func _Settings_ListRegionModules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRegionModulesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettingsServer).ListRegionModules(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.settings.v1.Settings/ListRegionModules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingsServer).ListRegionModules(ctx, req.(*ListRegionModulesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Settings_ListCameraModules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListCameraModulesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettingsServer).ListCameraModules(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.settings.v1.Settings/ListCameraModules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingsServer).ListCameraModules(ctx, req.(*ListCameraModulesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Settings_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListRegionModules",
			Handler:    _Settings_ListRegionModules_Handler,
		},
		{
			MethodName: "ListCameraModules",
			Handler:    _Settings_ListCameraModules_Handler,
		},
	},
