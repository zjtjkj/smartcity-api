...
const OperationRegionServiceGetBatchRegion = "/api.region.v1.RegionService/GetBatchRegion"
...
func RegisterRegionServiceHTTPServer(s *http.Server, srv RegionServiceHTTPServer) {
	...
	r.GET("/api/v1/region/batch/get", _RegionService_GetBatchRegion0_HTTP_Handler(srv))
}
...
func _RegionService_GetBatchRegion0_HTTP_Handler(srv RegionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetBatchRegionRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationRegionServiceGetBatchRegion)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetBatchRegion(ctx, req.(*GetBatchRegionRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*GetBatchRegionReply)
		return ctx.Result(200, reply)
	}
}
...
type RegionServiceHTTPClient interface {
	...
	GetBatchRegion(ctx context.Context, req *GetBatchRegionRequest, opts ...http.CallOption) (rsp *GetBatchRegionReply, err error)
...
func (c *RegionServiceHTTPClientImpl) GetBatchRegion(ctx context.Context, in *GetBatchRegionRequest, opts ...http.CallOption) (*GetBatchRegionReply, error) {
	var out GetBatchRegionReply
	pattern := "/api/v1/region/batch/get"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationRegionServiceGetBatchRegion))
	opts = append(opts, http.PathTemplate(pattern))
